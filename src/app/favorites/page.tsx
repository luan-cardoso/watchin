    ...
    <div className="px-10 pt-28 flex flex-col gap-16">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-5 items-center">
          <form>
            <div className="rounded-md p-3 bg-[#292929] border border-[#ffffff20] hover:border hover:border-emerald-600 duration-300 flex items-center gap-1">
          ...
          <button className="px-3 py-3 flex gap-1 items-center">
