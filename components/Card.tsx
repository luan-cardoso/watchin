...
export default function Card({
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-[5fr_2fr] h-96 w-64 bg-white/5 shadow-2xl overflow-hidden rounded-2xl">
      ...
      <div className="w-full py-2 px-4 flex flex-col justify-between">
        <h3 className="text-2xl font-bold text-ellipsis overflow-hidden line-clamp-1">{title}</h3>
